...
id = 'ingesta-favorites'
# logging configuration
logs_file = "logs_output/ingesta_favorites.log"
...
for page in paginator.paginate(**operation_parameters):
    ...
    # Guardar como json
    favorites_file = f'favorites.json'
    favorites.to_json(favorites_file, orient='records', lines=True)

    # Guardar en folder de bucket S3
    s3_favorites_file = f'favorites/favorites{i}.json'
    try:
